...
class BatchTest extends TestCase
{
    ...
    {
        $this->batchService = Fabric::getServiceBuilder()->getListsScope()->section()->batch;
    ...
    public function testBatchAdd(): void
    {
        ...
        try {
            ...
            foreach ($createdSectionIds as $createdSectionId) {
                try {
                    Fabric::getServiceBuilder()->getListsScope()->section()->delete(
                        'lists',
                        $this->testListId,
                        $createdSectionId
                    );
    ...
    public function testBatchUpdate(): void
    {
        ...
        $createdSectionIds = [];
        for ($i = 1; $i <= 3; $i++) {
            $addResult = Fabric::getServiceBuilder()->getListsScope()->section()->add(
                'lists',
                $this->testListId,
                $uniquePrefix . '_' . $i,
                [
